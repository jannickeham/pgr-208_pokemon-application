...
//
//  companion object{
//    fun createDataSet(): ArrayList<ImagePost>{
//      val list = ArrayList<ImagePost>()
//      list.add(
//        ImagePost(
...
//      list.add(
//        ImagePost(
//          "https://static.wikia.nocookie.net/poke5forum/images/6/60/028_Pikachu_%26_Zachary_28_88_20150911143525422.jpg/revision/latest?cb=20150911123651&path-prefix=de",
//        )
//      )
//
//      list.add(
